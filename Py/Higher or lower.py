...
def game():
    ...
    while should_continue:
        ...
        account_b_descr = account_b['description']
        ...
        print(vs)
        print(f"Against B: {account_b_name}, {account_b_descr}, from {account_b_country}.")

        ask = input("Who has more followers? Type 'A' or 'B': ")

        if account_follower > account_follower_b:
            answer = 'A'
        elif account_follower < account_follower_b:
            answer = 'B'
